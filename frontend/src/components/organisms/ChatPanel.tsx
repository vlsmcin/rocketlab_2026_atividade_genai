...
export function ChatPanel() {
  ...
  return (
    <section className="h-screen overflow-hidden px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
      <div className="mx-auto flex h-full w-full max-w-6xl flex-col gap-4">
        <header className="flex w-full items-center justify-between gap-4 rounded-[2rem] border border-white/60 bg-white/70 px-5 py-4 shadow-[0_20px_50px_-28px_rgba(15,23,42,0.45)] backdrop-blur">
          <div>
        ...
        <main className="grid min-h-0 flex-1 gap-4 lg:grid-cols-[18rem_minmax(0,1fr)]">
          ...
          <section className="flex min-h-0 flex-col rounded-[2.25rem] border border-white/70 bg-white/80 p-4 shadow-[0_24px_60px_-32px_rgba(15,23,42,0.55)] backdrop-blur">
